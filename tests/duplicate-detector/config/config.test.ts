...
describe("Configuration merging", () => {
  describe("mergeConfig", () => {
    it("should merge partial config with defaults", () => {
      ...
      expect(result.thresholds.semantic).toBe(
    ...
    it("should preserve undefined values correctly", () => {
      ...
      expect(result.filters.excludePatterns).toEqual(
        DEFAULT_CONFIG.filters.excludePatterns
      );
    });
  });
  ...
  describe("validateAndMergeConfig", () => {
    ...
    it("should throw error for invalid config", () => {
      ...
      expect(() => validateAndMergeConfig(userConfig)).toThrow(
    ...
    it("should log warnings for problematic but valid config", () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        expect.stringContaining("thresholds.syntactic")
      );
...
describe("Configuration file loading", () => {
  ...
  describe("loadConfigFromFile", () => {
    ...
    it("should handle file access errors", async () => {
      ...
      await expect(loadConfigFromFile("nonexistent.json")).rejects.toThrow(
    ...
    it("should handle validation errors in loaded config", async () => {
      ...
      await expect(loadConfigFromFile("invalid-config.json")).rejects.toThrow(
        "Configuration validation failed"
      );
    });
  });
