...
describe('ConfigBuilder', () => {
  ...
  describe('withThresholds', () => {
    it('should set threshold values', () => {
      ...
      expect(config.thresholds.structural).toBe(DEFAULT_CONFIG.thresholds.structural);
    });
  ...
  describe('withAnalysis', () => {
    it('should set analysis values', () => {
      ...
      expect(config.analysis.enablePatternDetection).toBe(DEFAULT_CONFIG.analysis.enablePatternDetection);
    });
  });
  ...
  describe('withOutput', () => {
    it('should set output values', () => {
      ...
      expect(config.output.groupSimilar).toBe(DEFAULT_CONFIG.output.groupSimilar);
    });
  });
  ...
  describe('withDefaults', () => {
    it('should apply default configuration', () => {
      ...
      expect(config.thresholds.syntactic).toBe(0.9);
      expect(config.thresholds.semantic).toBe(DEFAULT_CONFIG.thresholds.semantic);
  ...
  describe('complex scenarios', () => {
    ...
    it('should build valid configuration that passes validation', () => {
      ...
      expect(config.filters.excludePatterns).toEqual(['node_modules/**', '**/*.test.ts']);
