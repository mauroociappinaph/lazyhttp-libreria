import { HttpImplementation, RequestOptions, ApiResponse, AuthConfig, UserCredentials, AuthInfo, CacheConfig, MetricsConfig } from '../types';
...
export abstract class BaseHttpClient implements HttpImplementation {
  ...
  abstract request<T>(method: string, url: string, data?: any, options?: RequestOptions): Promise<ApiResponse<T>>;
